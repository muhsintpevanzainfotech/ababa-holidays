...
const Countries = () => {
  ...
  return (
    <div className="fade-in">
        ...
        <div className="filter-row">
          ...
          <div className="filter-actions">
            ...
            <div className="results-count">
              <span className="badge badge-primary">{filteredCountries.length}</span>
            ...
            <div key={country._id} className="card" style={{ padding: '0', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '20px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', borderTop: '1px solid var(--border)', paddingTop: '16px' }}>
                  <button className="action-btn" onClick={() => handleOpenModal('edit', country)}>
                    <Edit size={16} />
                  </button>
                  <button className="action-btn" style={{ color: '#e11d48' }} onClick={() => handleDelete(country._id)}>
                    <Trash2 size={16} />
                  </button>
                </div>
              </div>
                  ...
                  <tr key={country._id} style={{ borderBottom: '1px solid var(--border)' }}>
                    ...
                    <td style={{ padding: '16px 24px', textAlign: 'right' }}>
                      <div className="action-group">
                        <button className="action-btn" title="Edit Country" onClick={() => handleOpenModal('edit', country)}>
                          <Edit size={16} />
                        </button>
                        <button className="action-btn danger" title="Remove Country" onClick={() => handleDelete(country._id)}>
                          <Trash2 size={16} />
                        </button>
                      </div>
                    </td>
      ...
      <Drawer isOpen={showModal} onClose={() => setShowModal(false)} title={modalType === 'add' ? 'Add New Country' : 'Edit Country'}>
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div 
              ...
              onClick={() => document.getElementById('countryImage').click()}
            >
              {imagePreview ? (
