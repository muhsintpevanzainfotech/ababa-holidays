        ...
        <List disablePadding sx={{ pb: 1 }}>
          <ListItem alignItems="flex-start" disableGutters disablePadding>
            ...
            <ListItemText
              ...
              secondary={<Typography variant="caption">Vendor Support</Typography>}
            />
          </ListItem>
        </List>
        <Typography variant="caption" sx={{ color: 'primary.800', mt: 1, display: 'block' }}>
          support@ababatravels.com
        </Typography>
      </Box>
    </Card>
  );
